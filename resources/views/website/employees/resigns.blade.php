...
الدرجة الوظيفية
                        ...
                        @if ($user = request()->user())
                            ...
                            @if ($user->authority('admin') || $user->authority('reader') || $user->canEdit('insurance'))
                    ...
                    <tbody>
                        ...
                        @foreach($resigns as $employee)
                            ...
                            <tr>
                                ...
                                @if ($user->authority('admin') || $user->canEdit('insurance') ||  $user->authority('reader') || $user->canEdit('employee-images'))

                                    <td @if($user->canEdit('insurance')) style="display: none;" @endif>
